...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (loginForm) {
    loginForm.addEventListener("submit", async (e) => {
      ...
      try {
        const response = await fetch(`${config.API_BASE_URL}/.netlify/functions/login`, {
          method: "POST",
          headers: {
  ...
  if (changePasswordForm) {
    changePasswordForm.addEventListener("submit", async (e) => {
      ...
      try {
        const response = await fetch(`${config.API_BASE_URL}/.netlify/functions/change-password`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
